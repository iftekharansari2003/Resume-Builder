...
export const ehanceProfessionalSummary = async (req, res) => {
...
//Controller for enhancing a resume's Job Description summary
...
export const enhanceJobDescription = async (req, res) => {
    ...
    try {
        ...
        const enhanceContent = response.choices[0].message;
