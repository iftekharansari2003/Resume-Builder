    ...
    <div>
      {isLoading ? <Loading/> :(
        <div className='flex flex-col items-center justify-center h-screen'>
          ...
          <a href="/" className='mt-6 bg-blue-600 hover:bg-blue-600 text-white rounded-full px-6 h-9 m-1 ring-offset-1 ring-1 ring-blue-400 flex items-center transition-colors'>
