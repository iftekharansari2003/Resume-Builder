...
const ProfessionalSummaryForm = ({data, onChange, setResumeData}) => {
    ...
    const generateSummary = async()=>{
        try {
            ...
            const prompt = `enahnce my professional summary "${data}"`;
  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
            <textarea name="" id="" className='w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus' placeholder='Write a compelling professional summary that highlights your key strengths and career objectives...' rows={7} value={data || ""} onChange={(e)=>onChange(e.target.value)}/>
